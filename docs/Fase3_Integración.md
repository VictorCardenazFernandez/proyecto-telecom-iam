...
### 1. Nuevo microservicio: `provisioner`
...
### 2. Esquema de BD ampliado (`db/init.sql`)
...
### 4. Configuración AMI en Asterisk (`manager.conf`)
...
### 5. Pruebas unitarias (22 tests — todos pasando ✅)
